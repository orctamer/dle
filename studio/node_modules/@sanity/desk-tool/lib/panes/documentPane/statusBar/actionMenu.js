...
function ActionMenu(_ref) {
  ...
  (0, _useOnclickoutside.default)(clickOutsideRef, handleCloseMenu);

  var _useState = (0, _react.useState)(actionStates.find(s => !s.disabled)),
      _useState2 = _slicedToArray(_useState, 2),
      activeAction = _useState2[0],
      setActiveAction = _useState2[1];
